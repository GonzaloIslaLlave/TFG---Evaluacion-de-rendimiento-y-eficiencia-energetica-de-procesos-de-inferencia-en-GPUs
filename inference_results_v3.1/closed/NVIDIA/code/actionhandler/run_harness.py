...
class RunHarnessHandler(GenerateConfFilesHandler):
    """Handles the RunHarness 
action. This calls the underlying GenerateConfFilesHandler first to generate the
    ...
    def handle(self) -> bool:
		...
		# Start pm_set_server
            ...
            device_name = c_char_p(b'NVMLDevice')
		...
		# Start pm_print_data_csv
            ...
            #file_name = c_char_p(b'test_ocejon.csv')
            #file_name = b'test_' + self.benchmark_conf.get("config_name").encode('utf-8') + str(self.harness_flag_dict['gpu_batch_size']).encode('utf-8')  + str(self.harness_flag_dict['offline_expected_qps']).encode('utf-8') + b'.csv'
            ...
            destino = "/work/resultadosEnergiaA30"
