...
class OCEJON(MultiStreamGPUBaseConfig):
    ...
    #input_format: str = ''
    #map_path: str = ''
    multi_stream_expected_latency_ns: int = 40000000
    multi_stream_samples_per_query: int = 8
    multi_stream_target_latency_percentile: float = 99.0
    #precision: str = ''
    #tensor_path: str = ''
    ...
    disable_beta1_smallk: bool = True
